...
helicopter_damaged_1 = pygame.image.load('sprites/helicopter_damage_1.png')
helicopter_damaged_2 = pygame.image.load('sprites/helicopter_damage_2.png')
...
all_sprites = [helicopter_1, helicopter_2, helicopter_damaged_1, helicopter_damaged_2, enemy_helicopter_1,
               enemy_helicopter_2, helicopter_crash_1, helicopter_crash_2, helicopter_crash_3, helicopter_crash_4, boat,
               balloon, spaceship, icon, background, cloud]
